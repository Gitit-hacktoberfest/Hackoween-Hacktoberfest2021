"""
The purpose of this program is to update your discord status (hard coded) to an example sentence. For example, here it finds the number of days between your birthday and today.
Then it creates a sentence such as "Day XXXX of living in this simulation"
"""
